...
This .py file has been extracted from the LM_filter_bank folder attached in 
the main folder which has the license and readme files.
...
def makeLMfilters():
    ...
    count = nbar+nedge
    scales = np.array([1,np.sqrt(2),2,np.sqrt(8)])
